...
public class CopyDemo2 {
    public static void main(String[] args) throws IOException {
        RandomAccessFile src = new RandomAccessFile("光明.m4a", "r");
        RandomAccessFile desc = new RandomAccessFile("光明_cp.m4a","rw");
        /**
         * RAF提供的块读写方法：
         * 块写：
         ...
         * 块读：
         * int read(byte[] data)
         * 一次性从文件中读取给定的字节素数组data总长度的字节量并将
         ...
         * 与单字节读取区别：
         * int d = raf.read();//读取一个字节，返回值就是实际读取到的字节数据
